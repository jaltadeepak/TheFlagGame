...
function getRandomKey(countries) {
    const keys = Object.keys(countries);
    const randomIndex = Math.floor(Math.random() * keys.length);
    return keys[randomIndex];
}

let randomCountry = getRandomKey(countries);
let image = document.createElement('img');
const imgdiv = document.querySelector('.flagpic');
// const hintText = document.querySelector('.hint')

// function updateHintText(randomCountry){
//     hintText.innerText = "";
//     for(var letter = 0; letter < randomCountry.length; letter++){
//         if(randomCountry[letter] === ' '){
//             hintText.innerText += "  ";
//         } else {
//             hintText.innerText += "_ ";
//         }
//     }
// }
